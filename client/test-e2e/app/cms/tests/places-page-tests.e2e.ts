...
describe('Place page Tests: ', () => {
  ...
  it('check adding places', () => {
    PlacesPage.addPlaceButton.click().then(() => {
      ...
      AbstractPage.sendQuery(PlacesPage.inputFieldForEmail, 'test.ds1@gmail.com');
  ...
  it('check adding info to tab "Family Info"', () => {
    ...
    AbstractPage.sendQuery(
      PlacesPage.inputFamilyInfoSummaryOnPlacePage,
      'Test family Info summary: ....................'
    );
  ...
  it('check uploading images: upload diff types, check exceptions', () => {
    ...
    expect(PlacesPage.messageAboutExceptionUploadedImages.getText()).toEqual(
      'Sorry, the system does not support the following files'
    );
    expect(PlacesPage.messageAboutReasonExceptionUploadedImages.first().getText()).toEqual('Reason:');
    expect(PlacesPage.messageAboutReasonExceptionUploadedImages.last().getText()).toEqual(
