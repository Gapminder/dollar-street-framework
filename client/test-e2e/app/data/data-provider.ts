...
export class DataProvider {
  ...
  static teamPageTitle = 'Dollar Street Team';
  ...
  static matrixPageText = {
    ...
    H2INInHeader: {
      element: () =>
        element
          .all(by.css('div.filters-container span.income-title'))
          .first()
          .getText(),
  ...
  static mapPageQueries = {
    ThingPets: { query: 'Armchairs', count: 56 },
    ThingFamilySnapshots: { query: 'Family snapshots', count: 32 },
    ThingWalls: { query: 'Wall decorations', count: 53 },
    ThingFrontDoor: { query: 'Front doors', count: 54 },
    ThingSittingArea: { query: 'Sitting areas', count: 48 },
    ThingArmchair: { query: 'Cars', count: 31 },
    ThingBooks: { query: 'Books', count: 52 }
  };
  ...
  static photographerLinks = {
    JohanEriksson: {
      photographerLink: `${browser.baseUrl}/photographer/56ec0916af72e9437cbccf91`
    },
    JonathanTaylor: {
      photographerLink: `${browser.baseUrl}/photographer/56ec0917af72e9437cbccf94`
    },
    LucForsyth: {
      photographerLink: `${browser.baseUrl}/photographer/56ec0918af72e9437cbccf97`
    },
    RolandZsigmond: {
      photographerLink: `${browser.baseUrl}/photographer/56ec0917af72e9437cbccf95`
    },
    'Victrixia Montes': {
      photographerLink: `${browser.baseUrl}/photographer/56ec0916af72e9437cbccf90`
    }
  };
  ...
  static aboutPageLinksURLs = {
    ...
    termsOfUse: {
      selector: "a[href='https://docs.google.com/document/pub?id=1POd-pBMc5vDXAmxrpGjPLaCSDSWuxX6FLQgq5DhlUhM']"
    },
    PrivacyPolicy: {
      selector: "a[href='https://docs.google.com/document/d/1mjAd9CI42lqqENX2RRa0jQgtK4-ogqhhjCYrq9mjDfg/edit']"
    },
    signUpHere: {
      selector:
        "a[href='https://docs.google.com/a/gapminder.org/forms/d/e/1FAIpQLSdvIkRRpk0ikGYiimjtCTbCngLvIQeB6jz6KoTp2C_lciYzpw/viewform']"
    },
    qAndA: {
      selector:
        "a[href='https://docs.google.com/document/d/13u87BWz450cqvqr4TaiWi84yiNa5MOItr46_g1xRcTY/edit?usp=sharing']"
    },
    pressKit: { selector: "a[href='https://drive.google.com/drive/folders/0B0HB08a-a9MbVGJDX0hPSHhETnc']" },
    ideasAward: {
      selector:
        "a[href='https://www.fastcompany.com/3068873/announcing-the-winners-of-the-2017-world-changing-ideas-awards']"
    },
    brewhouseAward: { selector: "a[href='http://brewhouse.se/the-brewhouse-award/#the-brewhouse-award-2015']" },
    detailedIncomeCalculations: {
      selector: "a[href='https://drive.google.com/drive/folders/0B9jWD65HiLUnRm5ZNWlMSU5GNEU?usp=sharing']"
    },
