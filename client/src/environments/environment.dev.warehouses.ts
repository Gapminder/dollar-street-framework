export const environment = {
  ...
  NODE_ENV: 'warehouses',
  BASE_HREF: '',
  STRIPE_PUBLIC_KEY: 'pk_test_nXBlW739jt3oIGNdWOL7FUWk',
  PATH_TO_DOWNLOAD_IMAGES: '/v1/download-image/',
  FLAG_BUILD_ANGULAR_PRODUCTION: 'false',
  DEFAULT_STATE: {
    THING_ICON: 'Warehouse icon',
    THING_NAME: 'Warehouse',
    THING_HOME: 'Home',
    ...
    FILTER: 'Warehouses',
    PLACE_TYPE: 'Warehouses',
    FORM: '54d894b4870d9aac01482e6e'
  },
  ...
  S3_EMBED_VERSION: 'v1',
  S3_BUCKET: 'warehouses.dollarstreet.org',
