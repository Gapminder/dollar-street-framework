...
describe('FamilyHeaderComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [FamilyHeaderComponent, TranslateMeComponentMock, RegionMapComponentMock, TranslateKeyPipe],
      providers: [
        { provide: FamilyHeaderService, useClass: FamilyHeaderServiceMock },
        UtilsService // Achtung! Real service is called!!!
      ]
    });
  ...
  it('open expand block for short-family-info', () => {
    ...
    component.getFamilyHeaderData();
    fixture.detectChanges();
    const shortFamilyInfoBtn = fixture.debugElement.query(
      By.css('.short-family-info-container .image-container > img')
    );
    let expectedEvent;
    component.familyExpandBlock.subscribe((event) => (expectedEvent = event));
