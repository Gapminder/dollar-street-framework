...
describe('CountryPlacesComponent', () => {
      ...
      places: [
        {
          ...
          thing: 'Family',
          image:
            '//static.dollarstreet.org/media/Pakistan 1/image/7cda3510-1fb6-4d0c-b69d-0ee3a250e22d/thumb-7cda3510-1fb6-4d0c-b69d-0ee3a250e22d.jpg',
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CountryPlacesComponent, TranslateKeyPipe],
      providers: [{ provide: CountryPlacesService, useClass: MockCountryPlacesService }]
    });
