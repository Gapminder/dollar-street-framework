...
import { thingsFilterReducer, countriesFilterReducer } from '../../shared';
...
import { countryPlacesReducer } from '../../country/country-places/ngrx/country-place.reducers';
...
export const reducers: ActionReducerMap<AppStates> = {
  ...
  countryPlaces: countryPlacesReducer
};
