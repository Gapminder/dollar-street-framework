...
import { HtmlSanitizerPipe } from './pipes/sanitize-pipe/sanitize-html.pipe';
import { RoundToPipe } from './pipes/round/round.pipe';

import { Angulartics2Module } from 'angulartics2';
import { ImageLoadedService } from './image-loaded/image-loaded.service';
import { EscButtonDirective } from './ecs-directive/esc-button.directive';
import { TranslateKeyPipe } from './pipes/translate/translate-key.pipe';

@NgModule({
  imports: [HttpModule, RouterModule, CommonModule, DropdownModule, Angulartics2Module, TranslateModule, FormsModule],
  declarations: [
