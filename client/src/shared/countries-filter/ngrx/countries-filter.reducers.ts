...
export const initialState: CountriesFilterState = {
  ...
  countriesFilterTitle: null
};

export function countriesFilterReducer(
  state: CountriesFilterState = initialState,
  action: CountriesFilterActions.Actions
  ...
  switch (action.type) {
    ...
    case CountriesFilterActions.COUNTRIES_FILTER_TITLE:
      return Object.assign({}, state, { countriesFilterTitle: action.payload });
