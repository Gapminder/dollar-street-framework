...
@NgModule({
  declarations: [PhotographerComponent, PhotographerPlacesComponent, PhotographerProfileComponent],
  imports: [PhotographerRouting, HttpModule, RouterModule, CommonModule, SharedModule],
  providers: [PhotographerPlacesService, PhotographerProfileService],
  exports: []
})
