...
import { LanguageServiceMock, UrlChangeServiceMock, AngularticsMock } from '../../../test/';
...
describe('PhotographerProfileComponent', () => {
  ...
  beforeEach(async () => {
    TestBed.configureTestingModule({
      imports: [HttpModule, TranslateModule, Angulartics2Module],
      declarations: [PhotographerProfileComponent, TranslateKeyPipe],
      providers: [
        Location,
        LocationStrategy,
        MathService,
