...
import { LoaderServiceMock, LanguageServiceMock } from '../../../test/';
...
import { ThingsFilterPipe } from '../../../shared/things-filter/things-filter.pipe';
...
describe('PhotographerPlacesComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule, Angulartics2Module, TranslateModule, StoreModule.forRoot({})],
      declarations: [PhotographerPlacesComponent, TranslateKeyPipe],
      providers: [
        MathService,
