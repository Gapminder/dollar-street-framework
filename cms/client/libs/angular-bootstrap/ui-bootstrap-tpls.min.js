      ...
      return {
        link: function(b, c, d) {
          ...
          function f() {
            k
              ? ((k = !1), g())
              : (c.removeClass('collapse').addClass('collapsing'), e({ height: c[0].scrollHeight + 'px' }).then(g));
          }
          function g() {
    ...
    .controller('CarouselController', [
      ...
      function(a, b, c, d) {
        ...
        (j.select = a.select = function(c, f) {
            ...
            if (!m) {
              if (j.currentSlide && angular.isString(f) && !a.noTransition && c.$element) {
                ...
                angular.forEach(k, function(a) {
                  ...
                  angular.extend(c, { direction: f, active: !0, entering: !0 }),
                  angular.extend(j.currentSlide || {}, { direction: f, leaving: !0 }),
          ...
          function h(b, c) {
            angular.extend(b, { direction: '', active: !0, leaving: !1, entering: !1 }),
              angular.extend(c || {}, { direction: '', active: !1, leaving: !1, entering: !1 }),
              (a.$currentTransition = null);
          }
          var i = k.indexOf(c);
          void 0 === f && (f = i > l ? 'next' : 'prev'),
            c && c !== j.currentSlide && (a.$currentTransition ? (a.$currentTransition.cancel(), b(g)) : g());
        }),
          a.$on('$destroy', function() {
            m = !0;
          }),
          ...
          (j.addSlide = function(b, c) {
            (b.$element = c),
              k.push(b),
              1 === k.length || b.active ? (j.select(k[k.length - 1]), 1 == k.length && a.play()) : (b.active = !1);
          }),
        ...
        (this.modes = ['day', 'month', 'year']),
          ...
          (this.isDisabled = function(c) {
            return (
              ...
              (b.dateDisabled && a.dateDisabled({ date: c, mode: a.datepickerMode }))
            );
          }),
              ...
              (e.handleKeyDown = function(a) {
                ...
                if ('left' === a) b -= 1;
                  ...
                  e.activeDate.setMonth(c, 1),
                    (b = Math.min(f(e.activeDate.getFullYear(), e.activeDate.getMonth()), b));
                } else
      ...
      function(a, b, c, d, e, f, g) {
        return {
          ...
          link: function(h, i, j, k) {
            ...
            j.datepickerOptions &&
              angular.forEach(h.$parent.$eval(j.datepickerOptions), function(a, b) {
                r.attr(l(b), a);
              }),
              (h.watchData = {}),
              angular.forEach(['minDate', 'maxDate', 'datepickerMode'], function(a) {
                if (j[a]) {
                  var c = b(j[a]);
                  if (
              ...
              (h.select = function(a) {
                if ('today' === a) {
                  ...
                  angular.isDate(k.$modelValue)
                    ? ((a = new Date(k.$modelValue)), a.setFullYear(b.getFullYear(), b.getMonth(), b.getDate()))
          ...
          function(b, c, d, e, f, g, h) {
            function i(a) {
              return a.template
                ? d.when(a.template)
                : e
                    .get(angular.isFunction(a.templateUrl) ? a.templateUrl() : a.templateUrl, { cache: f })
                    .then(function(a) {
                      return a.data;
                    });
            }
            ...
            return (
              (k.open = function(b) {
                ...
                if (
                  ((b = angular.extend({}, a.options, b)), (b.resolve = b.resolve || {}), !b.template && !b.templateUrl)
                )
        ...
        return {
          ...
          link: function(c, d, e, f) {
            ...
            function h(a, b) {
              ...
              f &&
                (l
                  ? ((d = Math.max(a - Math.floor(k / 2), 1)), (e = d + k - 1), e > b && ((e = b), (d = e - k + 1)))
                  : ((d = (Math.ceil(a / k) - 1) * k + 1), (e = Math.min(d + k - 1, b))));
              for (var h = d; e >= h; h++) {
                var i = g(h, h, h === a);
                c.push(i);
              }
        ...
        (this.init = function(e) {
          ...
          (a.onKeydown = function(b) {
            /(37|38|39|40)/.test(b.which) &&
              (b.preventDefault(), b.stopPropagation(), a.rate(a.value + (38 === b.which || 39 === b.which ? 1 : -1)));
          }),
          (this.render = function() {
            a.value = d.$viewValue;
          });
        ...
        return {
          ...
          link: function(i, j, k, l) {
                    ...
                    if (d && m)
                      if (c.length > 0) {
                        ...
                        (x.query = a),
                          ...
                          (x.position.top = x.position.top + j.prop('offsetHeight')),
            ...
            l.$parsers.unshift(function(a) {
              return (
                (m = !0),
                a && a.length >= n ? (o > 0 ? (F(), E(a)) : C(a)) : (q(i, !1), F(), A()),
                p ? a : a ? void l.$setValidity('editable', !1) : (l.$setValidity('editable', !0), a)
              );
            }),
              ...
              j.bind('keydown', function(a) {
                0 !== x.matches.length &&
                  ...
                  (a.preventDefault(),
                  40 === a.which
                    ? ((x.activeIdx = (x.activeIdx + 1) % x.matches.length), x.$digest())
                    : 38 === a.which
